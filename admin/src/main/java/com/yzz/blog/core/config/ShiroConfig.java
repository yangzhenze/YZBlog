...
import com.yzz.blog.core.shiro.credentials.RetryLimitCredentialsMatcher;
import com.yzz.blog.core.shiro.realm.ShiroRealm;
import com.yzz.blog.framework.property.RedisProperties;
import com.yzz.blog.framework.property.ShiroProperties;
import com.yzz.blog.framework.redis.CustomRedisManager;
...
public class ShiroConfig {
     ...
     * 初始化ShiroFilterFactoryBean的时候需要注入：org.apache.shiro.mgt.SecurityManager
     * Filter Chain定义说明
    ...
    public ShiroFilterFactoryBean shirFilter(org.apache.shiro.mgt.SecurityManager securityManager) {
        ...
        // 必须设置 org.apache.shiro.mgt.SecurityManager
    ...
    public org.apache.shiro.mgt.SecurityManager securityManager(@Qualifier("shiroRealm") ShiroRealm authRealm) {
